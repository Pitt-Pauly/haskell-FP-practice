...
--  * Added NNF and CNF transformations (see optional exercises)


-- Informatics 1 - Functional Programming 
-- Tutorial 6
--
-- Week 8 - due: 13/14 Nov.
...
-- creates all possible truth assignments for a list of variables
envs :: Names -> [Env]
envs []      =  [[]]
...
equivalent prop1 prop2 = and [(eval e prop1) == (eval e prop2) | e <- envs (nub (names prop1 ++ names prop2))]

equivalent2 :: Prop -> Prop -> Bool
equivalent2 prop1 prop2 = e1 == e2
   where 
     env_all = envs (nub (names prop1 ++ names prop2))
     e1 = [ eval env1 prop1 | env1 <- env_all ]
     e2 = [ eval env1 prop2 | env1 <- env_all ]       

equivalent' :: Prop -> Prop -> Bool
equivalent' prop1 prop2 = tautology ((prop1 :&: prop2) :|: (Not prop1 :&: Not prop2)) 
